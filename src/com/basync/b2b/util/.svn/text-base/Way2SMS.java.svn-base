...
public class Way2SMS {
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
            ...
            System.out.println(loginConnection.getOutputStream()+"Hello");
            //Reading the cookie
           ...
           System.exit(0);
            ...
            System.err.println("Can not connect to Login URL Error");
            System.exit(0);
        }
    ...
    public void sendSMS(String phoneNumber,String message,String action)
    {
            ...
            try {
               ...
               // sendURL=new URL("http://site5.way2sms.com/FirstServletsms?custid=");
                ...
                sendURL=new URL("http://site5.way2sms.com/quicksms.action?custid=undefined&HiddenAction=instantsms&Action="+action+"&login=9172426968&pass=bharat123&MobNo="+phoneNumber+"&textArea="+message);
                //sendURL+=
                if(proxy==null)
                {
                    sendConnection = (HttpURLConnection) sendURL.openConnection();
                }
                //test number 9930990674
                else
                {
                    sendConnection = (HttpURLConnection) sendURL.openConnection(proxy);
                }
                sendContent="custid=undefined&HiddenAction=instantsms&Action="+action+"&login=9172426968&pass=bharat123&MobNo="+phoneNumber+"&textArea="+message;
    ...
    public static void main(String args[])
    {
        ...
        String textMessage= "One who wins without problem, its just VICTORY.But One who wins with lots of Trouble, He Creates HISTORY.";
