...
/*
	...
	Password Length:
		5 Points: Less than 6 characters
		10 Points: 6 to 8 characters
		25 Points: 9 or more
...
function checkPassword(strPassword)
{
	...
	// -- 6 to 8 characters
	else if (strPassword.length > 5 && strPassword.length < 9)
	{
		nScore += 10;
	}
	// -- 9 or more
...
function runPasswordStrengthCheck(strPassword, strFieldID) 
{
	// Check password
