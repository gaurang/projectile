	...
	<div class="container">
		<div align="center" class="content">
			...
			<form:form method="post" cssClass="cmxform"
				action="RegistrationController.html" commandName="registrationDO"
				name="rform" id="rform">
				...
				<table width="85%" border="0" align="center">
					<tr>
						<td colspan="2" class="heading">Company Details<span
							class="ttl_names">(<span class="astrix">*</span> Mandatory
								Fields)</span>
						</td>
						<td></td>
					...
					<tr>
						...
						<td width="28%"><form:input path="companyName" id="cname"
								cssClass="required input" size="25" maxlength="100" /></td>
						<td height="21"><span class="ttl_names">Member of any
								association</span>
						</td>
						<td><form:input path="memberOfAssociation" cssClass="input"
								size="25" />
						</td>
					...
					<tr>
						...
						<td><form:input path="brokerName" cssClass="input" size="25" />
						</td>
						<td class="ttl_names">Telephone 1<span class="astrix">*</span>
						</td>
						<td><div>
								<form:input cssClass="required number input" size="25"
									id="telphone1" path="telphone1" />
							</div></td>
					</tr>
					<tr>
						<td class="ttl_names">Business Type<span class="astrix">*</span>
						</td>
						<td><label> <form:select path="businessType"
									cssClass="required list_box" id="select">
						...
						<td><div>
								<form:input path="telphone2" id="telphone23"
									cssClass="number input" size="25" />
							</div>
						</td>
					</tr>
					<tr>
						<td class="ttl_names">Name<span class="astrix">*</span>
						</td>
						<td><form:input path="cName" cssClass="required" size="25" />
						</td>
						<td class="ttl_names">Fax</td>
						<td><form:input path="fax" id="fax3" cssClass="number input"
								size="25" />
						</td>
					</tr>
					<tr>
						<td class="ttl_names">Designation<span class="astrix">*</span>
						</td>
						<td><form:input path="designation" size="25"
								cssClass="required" />
						</td>
						<td class="ttl_names">Mobile<span class="astrix">*</span>
						</td>
						<td><form:input path="cMobile" cssClass="required number"
								size="25" />
						</td>
					</tr>
					<tr>
						<td rowspan="2" valign="top" class="ttl_names">Address<span
							class="astrix">*</span>
						</td>
						<td rowspan="2" valign="top"><form:textarea path="address"
								cols="19" cssClass="required input_big"></form:textarea>
						</td>
						<td class="ttl_names">Email<span class="astrix">*</span>
						</td>
						<td><form:input path="cEmail" cssClass="required email"
								size="25" />
						</td>
					</tr>
					<tr>
						<td class="ttl_names">Alternate Email</td>
						<td><form:input path="alternateEmail" cssClass="input"
								size="25" /></td>
					</tr>
					<tr>
						<td class="ttl_names">City<span class="astrix">*</span>
						</td>
						<td><form:input path="city" cssClass="required input"
								size="25" />
						</td>
						<td class="ttl_names">Website</td>
						<td><form:input path="webSiteName" cssClass="input" size="25" />
						</td>
					</tr>
					<tr>
						<td class="ttl_names">State<span class="astrix">*</span>
						</td>
						<td><form:input path="state" size="25"
								cssClass="required input" />
						</td>
						<td class="ttl_names">Comments</td>
						<td rowspan="3" valign="top"><label> <form:textarea
									path="comments" cols="19" rows="3" cssClass="input_big"></form:textarea>
						</label>
						</td>
					</tr>
					<tr>
						<td class="ttl_names">Country <span class="astrix">*</span>
						</td>
						<td><form:select path="country" cssClass="required list_box"
								tabindex="9" id="ddlCcountry">
					...
					<tr>
						<td width="22%" class="ttl_names">Pin Code<span
							class="astrix">*</span>
						</td>
						<td width="28%"><form:input path="pinCode"
								cssClass="required input" size="25" />
						</td>
				...
				<div id="login_detail">
					<table width="85%" border="0" align="center">
						<c:if test="${registrationDO.ID == null}">
							...
							<tr>
								<td width="22%" class="ttl_names">Username<span
									class="astrix"><em>*</em>
								</span>
								</td>
								<td width="28%" id="userTag"><form:input path="loginName"
										cssClass="required" size="25" onblur="checkUser(this);" /> <span
									id="userMsg"></span>
								</td>
								<td width="22%" class="ttl_names">Confirm Password<span
									class="astrix">*</span>
								</td>
								<td width="28%"><form:password path="confirmPassword"
										cssClass="required" size="25" />
								</td>
							</tr>
							<tr>
								<td class="ttl_names">Password <span class="astrix">*</span>
								</td>
								<td><form:password path="password"
										cssClass="required input" size="25" />
								</td>
								<td class="ttl_names">Send me Email Updates</td>
								<td valign="middle" class="ttl_names"><form:radiobutton
										path="emailUpdates" value="1" cssStyle="width:auto!important;" />
									Yes <form:radiobutton path="emailUpdates" value="0"
										cssStyle="width:auto!important;" /> No</td>
							</tr>
							<c:if test="${registrationDO.ID > 0}">
								<tr>
									<td class="ttl_names">Sequrity Question <span
										class="astrix">*</span>
									</td>
									<td><form:select path="question"
											cssClass="required list_box">
									...
									<td><form:input path="answer" cssClass="required input"
											size="25" /></td>
								</tr>
							</c:if>
							<tr>
						...
						<tr>
							...
							<td height="21" align="right"><table width="70" border="0">
									<tr>
										<td width="97" height="27" class="button"><input
							...
							<td height="21"><table width="70" border="0">
									<tr>
										<td width="97" height="28" class="button"><input
											type="button" value="Reset" onclick="this.form.reset();" />
										</td>
									</tr>
								</table>
							</td>
